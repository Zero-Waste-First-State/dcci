...
//import SiftingCompost from "@/components/tasks/sifting-compost";
import SiftCompostOption from '@/components/tasks/sift-compost';

// 🪣
function SiftingCompostContent() {
  ...
  return (
    <>
      ...
      >
        ...
        <BackButton />
        <FormHeading subHeading="Sifting Compost" />
        ...
        <div
          ...
          <SiftCompostOption searchParams={searchParams} />
        </div>
      </motion.main>
    </>
  );
